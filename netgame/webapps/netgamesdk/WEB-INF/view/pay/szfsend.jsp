...
<c:url value="/szf/${fromid}/${uid}" var="yidongzf"></c:url>
<body>
<form action="${yidongzf}" method="post" id="cardInfo">
	<table>
		<tr><td>移动卡序列号:</td><td><input type="text" name="cardSN"/></td></tr>
		<tr>
		<td>移动卡面值:</td>
		<td>
		...
		<tr><td>移动卡密码:</td><td><input type="text" name="cardPassword"/></td></tr>
