...
<c:url var="yidong" value="/szf/${uid}/${fromid}/${yidong}/szfSend.do"></c:url>
<c:url var="liantong" value="/szf/${uid}/${fromid}/${liantong }/szfSend.do"></c:url>
<c:url var="dianxin" value="/szf/${uid}/${fromid}/${dianxin }/szfSend.do"></c:url>
